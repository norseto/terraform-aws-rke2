...
| <a name="input_addons"></a> [addons](#input\_addons) | Addon configurations | <pre>object({<br>    aws_ebs_csi_driver = optional(string, "latest")<br>  })</pre> | <pre>{<br>  "aws_ebs_csi_driver": "none"<br>}</pre> | no |
